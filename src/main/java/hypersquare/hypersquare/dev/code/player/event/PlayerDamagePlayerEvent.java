...
public class PlayerDamagePlayerEvent implements CancellableEvent {
    @Override
    public ItemStack item() {
        return new EventItem()
            .setMaterial(Material.IRON_SWORD)
            .setName(Component.text("Player Damage Player Event").color(Colors.RED_LIGHT))
            .setDescription(
                Component.text("Executes code when a player"),
                Component.text("damages another player."))
            .setCancellable(true)
            .build()
            ;
    }
